...
class SoundTrigger:
    def __init__(self):
        ...
        self.cymbal_sound = pygame.mixer.Sound('/Users/begumarici/Desktop/airdrum/assets/Ensoniq-SQ-1-Ride-Cymbal.wav')
        self.crash_sound = pygame.mixer.Sound('assets/Crash-Cymbal-1.wav')
        self.bass_kick_sound = pygame.mixer.Sound('/Users/begumarici/Desktop/airdrum/assets/Bass-Drum-2.wav')  
